...
export const RevenueSummary: React.FC<RevenueSummaryProps> = ({ propertyId = 'prop-001', debugTenant, showRaw }) => {
    ...
    // ISSUE 3: extra frontend rounding on float values can compound precision artifacts.
    // old code: const displayTotal = Math.round(data.total_revenue * 100) / 100;
    // FIX: trust backend's currency-precision value and format only for display.
